            ...
            >
              <ul className='navigation navigation-main'>
                <VerticalNavMenuItems
                  items={role === 'ACCOUNTANT' ?  accountant : (role === 'PRODUCTION' ? productionManager :  (role === 'SALES' ? store :  (role === 'FINANCE' ? manager :  (role === 'FACTORY_FINANCE' ? '' : (role === 'PROCUREMENT' ? '' : navigation))))) }
