...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/calendar/events').reply(config => {
...
// // POST: Add new event
// // ------------------------------------------------
// mock.onPost('/BPC/apps/calendar/add-event').reply(config => {
...
// // POST: Update Event
// // ------------------------------------------------
// mock.onPost('/BPC/apps/calendar/update-event').reply(config => {
...
// // DELETE: Remove Event
// // ------------------------------------------------
// mock.onDelete('/BPC/apps/calendar/remove-event').reply(config => {
