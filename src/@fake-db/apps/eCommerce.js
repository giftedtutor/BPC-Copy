...
// // GET: Return products
// // ------------------------------------------------
// mock.onGet('/BPC/apps/ecommerce/products').reply(config => {
...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/ecommerce/wishlist').reply(() => {
...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/ecommerce/cart').reply(() => {
...
// // ------------------------------------------------
// mock.onPost('/BPC/apps/ecommerce/cart').reply(config => {
...
// // ------------------------------------------------
// mock.onPost('/BPC/apps/ecommerce/wishlist').reply(config => {
//   // Get product from post data
//   const { productId } = JSON.parse(config.data)
