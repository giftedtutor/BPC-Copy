...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/chat/chats-and-contacts').reply(() => {
...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/chat/users/profile-user').reply(() => [200, data.profileUser])

// // ------------------------------------------------
// // GET: Return Single Chat
// // ------------------------------------------------
// mock.onGet('/BPC/apps/chat/get-chat').reply(config => {
...
// // ------------------------------------------------
// mock.onPost('/BPC/apps/chat/send-msg').reply(config => {
