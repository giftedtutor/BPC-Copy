...
// // GET: Return Emails
// // ------------------------------------------------
// mock.onGet('/BPC/apps/email/emails').reply(config => {
...
// // POST: Update Email
// // ------------------------------------------------
// mock.onPost('/BPC/apps/email/update-emails').reply(config => {
...
// // ------------------------------------------------
// mock.onPost('/BPC/apps/email/update-emails-label').reply(config => {
...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/email/get-email').reply(config => {
//   const { id } = config
...
// // ------------------------------------------------
// mock.onGet('/BPC/apps/email/paginate-email').reply(config => {
