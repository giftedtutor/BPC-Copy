...
// // GET: Return Tasks
// // ------------------------------------------------
// mock.onGet('/BPC/apps/todo/tasks').reply(config => {
...
// // POST: Add new task
// // ------------------------------------------------
// mock.onPost('/BPC/apps/todo/add-tasks').reply(config => {
...
// // POST: Update Task
// // ------------------------------------------------
// mock.onPost('/BPC/apps/todo/update-task').reply(config => {
...
// // DELETE: Remove Task
// // ------------------------------------------------
// mock.onDelete('/BPC/apps/todo/delete-task').reply(config => {
