...
// // GET ALL DATA
// // mock.onGet('http://thesfb.live/BPC_Backend/api/getSuppliers').reply(200, data.users)

// // POST: Add new user
// mock.onPost('/BPC/apps/users/add-user').reply(config => {
...
// // DELETE: Deletes User
// mock.onDelete('/BPC/apps/users/delete').reply(config => {
