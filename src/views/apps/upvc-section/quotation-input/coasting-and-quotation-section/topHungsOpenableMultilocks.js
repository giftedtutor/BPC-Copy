...
/* eslint-disable semi */
const topHungsOpenableMultilocks = (InputValues, itemID, estQty) => {
  // ML 600
  if (itemID === 3689) {
    const quantity = []
    InputValues.forEach((data, index) => {
      const multiLockNo =
        InputValues[index].customFirstTop?.Type === "Openable" &&
        InputValues[index].customFourthTop?.Type === "Openable"
          ? 2
          : InputValues[index].customFirstTop?.Type === "Openable" &&
            InputValues[index].customThirdTo?.Type === "Openable"
          ? 2
          : InputValues[index].customFirstTop?.Type === "Openable" &&
            InputValues[index].customSecondTop?.Type === "Openable"
          ? 2
          : 1;
...
export default topHungsOpenableMultilocks;
