            ...
            <div className="inner-page">
              ...
              <div className="form-row">
                <div className="form-group col-md-8">
                  <h6 className="h11">Koncept Window & Door Systems</h6>

                  <p style={{
                    fontSize: 10,
                    marginTop: -5
                  }}>Address: #188 Street 1 lane 4, Peshawar Road, Rawalpindi</p>

                  <p style={{
                    fontSize: 10,
                    marginTop: -23
                  }}>Phone: 051 8444 580 </p>
                  <p style={{
                    fontSize: 10,
                    marginTop: -23
                  }}>Mobile: +92 335 3654321</p>
                  <p style={{
                    fontSize: 10,
                    marginTop: -23
                  }}>Email: info@koncept-solutions.com </p>
                  <p style={{
                    fontSize: 10,
                    marginTop: -23
                  }}> Koncept-solution.com </p>
