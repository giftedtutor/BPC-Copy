      ...
      >
        ...
        >
          ...
          >
            ...
            <div style={{
              display: 'flex',
              justifyContent: slideFourSash === 'SashNew' ? 'flex-start' : 'flex-end',
              alignItems: 'flex-end',
              height: '50%'
            }}
              onClick={() => setSlideFourSash(sash)}
            >
              {
                slideFourSash === 'SashNew' ? <img src={sashAsset} alt='SASH' style={{ height: '70%', width: '30%' }} /> : (
                  slideFourSash === 'SashNewRot' ? <img src={sashAssetRot} alt='SASH' style={{ height: '70%', width: '30%' }} /> : ''
                )
              }
            </div>
          </div>
